...
├── backend/                        # 백엔드
│   ├── services/
│   │   ├── gateway/                # @trustee/gateway - API Gateway
│   │   ├── trustee/                # @trustee/trustee-service
│   │   └── inspection/             # @trustee/inspection-service
│   └── packages/
│       ├── common/                 # @trustee/common - 공유 유틸리티
...
│       │       ├── client.ts
│       │       └── index.ts
│       ├── proto/                  # @trustee/proto - gRPC proto 파일
